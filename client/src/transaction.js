...
function Transaction() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://localhost:8000/api/users/depot/${userId1}`,transctionData);
      await axios.put(`http://localhost:8000/api/users/ajout/${userId2}`,transctionData);
      navigate("/compte")
  ...
  <div className="containe">
      ...
      <div className="field confirm-password">
          <div className="input_register">
            <input
              type="text"
              placeholder="num_compte1"
              className="num_compte1" name="num_compte1" onChange={handleChange}   required value={transctionData.num_compte1}
            />
        ...
        <div className="field confirm-password">
          <div className="input_register">
            <input
              type="text"
              placeholder="num_compte2"
              className="num_compte2" name="num_compte2" onChange={handleChange}   required value={transctionData.num_compte2}
            />
